...
class MainActivity13 : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val btnNavigateLostItem: Button = findViewById(R.id.postlostitem)
        btnNavigateLostItem.setOnClickListener {
            val intent = Intent(this, PostLostItem::class.java)
            startActivity(intent)
        }

        val btnNavigateFoundItem: Button = findViewById(R.id.postfounditem)
        btnNavigateFoundItem.setOnClickListener {
